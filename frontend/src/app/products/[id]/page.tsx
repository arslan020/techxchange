      ...
      <div className="grid gap-10 md:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-6 flex gap-3">
            <button className="rounded-lg bg-gradient-to-r from-[#ff5757] to-[#ff3131] px-5 py-2.5 font-semibold text-white">
              Add to cart
            </button>
            <a
          ...
          {/* details list (optional extras) */}
          <div className="mt-8 space-y-2 text-sm text-zinc-700">
            {/* Add bullet points/specs here if you track them */}
          </div>
        </div>
      </div>
